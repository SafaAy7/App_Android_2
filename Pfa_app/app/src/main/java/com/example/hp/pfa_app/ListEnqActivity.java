...
public class ListEnqActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    Enquataire_adapter enquataire_adapter;
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for(int i=0;i<array.length();i++){
                        ...
                        Enquataire e = new Enquataire(object.getInt("id"),
...
//                    enquataire_adapter = new Enquataire_adapter(getApplicationContext(),enquataires);
        ...
        enquataire_adapter.OnItemClickListener(new Enquataire_adapter.OnItemClickListener() {
            @Override
            public void onItemClick(int posistion) {
              //  Toast.makeText(getApplicationContext(),String.valueOf(posistion),Toast.LENGTH_LONG).show();
                Intent intent = new Intent(getApplicationContext(),Mod_EnqueteurActivity.class);
                Bundle b = new Bundle();
    ...
    public boolean onOptionsItemSelected( MenuItem item) {
        if (item.getItemId()==R.id.addeq) {
            ...
            //    Toast.makeText(getApplicationContext(), "Ouverture de l' Enquetaire....", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(getApplicationContext(), EnquateurActivity.class));
                }
