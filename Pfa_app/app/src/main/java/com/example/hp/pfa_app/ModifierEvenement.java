...
public class ModifierEvenement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modif_even);
    ...
    imageView = (ImageView)findViewById(R.id.imageView9);
        ...
        id =b.getString("id");
        editTextNom.setText(b.getString("nom"));
        editeTextDescription.setText(b.getString("description"));
        editTextContact.setText(b.getString("contact"));
        editTextAddress.setText(b.getString("lieu"));
        editTextDate.setText(b.getString("date"));
        editTextResponsable.setText(b.getString("responsable"));

        Picasso.with(getApplicationContext()).load("http://192.168.1.6:82/pfaapp/evenments/images/"+b.getString("image")).into(imageView);
...
//                StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://20.20.0.206:82/pfaapp/evenments/insertEvenment.php", new Response.Listener<String>() {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://192.168.1.6:82/pfaapp/evenments/editer.php", new Response.Listener<String>() {
                @Override
            ...
            startActivity(new Intent(getApplicationContext(),ListEvenmentActivity.class));
        }
