...
public class Enqueteur_adapter extends RecyclerView.Adapter<Enqueteur_adapter.EnqueteurViewHolder> {
    ...
    public Enqueteur_adapter(Context ctx, List<Enqueteur> enquataires) {
        this.ctx = ctx;
    ...
    public void onBindViewHolder(EnqueteurViewHolder holder, final int position) {
        final Enqueteur enquataire = enquataires.get(position);
